...
2. 1. Icons should be **scalable** and **consistent**, avoiding excessive resizing that can distort clarity. **SVG** is the preferred format for sharpness and responsiveness, while **PNG** is suitable for fixed-size icons if optimized. 
